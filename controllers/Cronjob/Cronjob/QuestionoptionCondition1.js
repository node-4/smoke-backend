                ...
                if (findUser) {
                    ...
                    if (totalQuestion[i].condition1 == true) {
                        if (((findUser.friends.length) == 0) && (findSchoolMember.length == 0)) {
                            ...
                            condition1Function(totalQuestion[i].userID, totalQuestion[i].fullDate, totalQuestion[i].hrs3)
                            ...
                            if (update.condition2 == true) {
                                ...
                                condition2Function(totalQuestion[i].userID, totalQuestion[i].fullDate, totalQuestion[i].hrs3)
                            }
                            ...
                            if (update.condition3 == true) {
                                condition3Function(totalQuestion[i].userID, totalQuestion[i].fullDate, totalQuestion[i].hrs3)
                            }
                        } else {
...
async function condition2Function(userId, fullDate, hrs3) {
    let totalQuestion = await questionAnswer.find({ questionDate: fullDate, questionTime: hrs3, userID: userId })
    if (totalQuestion.length > 0) {
        for (let i = 0; i < totalQuestion.length; i++) {
            if (totalQuestion[i].optionCount == 14) {
                console.log("141-----------------------------", totalQuestion[i].optionCount);
            } else {
                let findUser = await user.findById({ _id: totalQuestion[i].userID })
                if (findUser) {
                    let findSchoolMember = await user.find({ _id: { $ne: findUser._id }, school: findUser.school });
                    if (totalQuestion[i].condition2 == true) {
                        ...
                        if ((0 < findSchoolMember.length < 4) && (0 < findUser.friends.length < 4)) {
                            if (totalQuestion[i].priority2_1 == true) {
                                ...
                                condition2priority1(totalQuestion[i].userID, totalQuestion[i].fullDate, totalQuestion[i].hrs3)
                            }
                            if (totalQuestion[i].priority2_2 == true) {
                                console.log("142-------------condition2Function", findUser.firstName);
                                condition2priority2(totalQuestion[i].userID, totalQuestion[i].fullDate, totalQuestion[i].hrs3)
                            }
...
async function condition3Function(userId, fullDate, hrs3) {
    console.log("164-------------condition3Function", findUser.firstName);
    let totalQuestion = await questionAnswer.find({ questionTime: hrs3, questionDate: fullDate, userID: userId })
    if (totalQuestion.length > 0) {
        for (let i = 0; i < totalQuestion.length; i++) {
            if (totalQuestion[i].optionCount == 14) {
                console.log("182-----------------------------", totalQuestion[i].optionCount);
            } else {
                let findUser = await user.findById({ _id: totalQuestion[i].userID })
                if (findUser) {
                    let findSchoolMember = await user.find({ _id: { $ne: findUser._id }, school: findUser.school });
                        ...
                        if (findUser.friends.length >= 4) {
                            if (totalQuestion[i].optionCount == 14) {
                                ...
                                if (totalQuestion[i].priority1 == true) {
                                    ...
                                    condition3priority1(totalQuestion[i].userID, totalQuestion[i].fullDate, totalQuestion[i].hrs3)
                                }
                                if (totalQuestion[i].priority2 == true) {
                                    console.log("182-------------condition3Function", findUser.firstName);
                                    condition3priority2(totalQuestion[i].userID, totalQuestion[i].fullDate, totalQuestion[i].hrs3)
                                }
                                if (totalQuestion[i].priority3 == true) {
                                    console.log("186-------------condition3Function", findUser.firstName);
                                    condition3priority3(totalQuestion[i].userID, totalQuestion[i].fullDate, totalQuestion[i].hrs3)
                                }
                                if (totalQuestion[i].priority4 == true) {
                                    console.log("190-------------condition3Function", findUser.firstName);
                                    condition3priority4(totalQuestion[i].userID, totalQuestion[i].fullDate, totalQuestion[i].hrs3)
                                }
                                if (totalQuestion[i].priority5 == true) {
                                    console.log("194-------------condition3Function", findUser.firstName);
                                    condition3priority5(totalQuestion[i].userID, totalQuestion[i].fullDate, totalQuestion[i].hrs3)
                                }
                            }
                        } else if ((0 < findSchoolMember.length < 4) && (0 < findUser.friends.length < 4)) {
...
async function condition2priority1(userId, fullDate, hrs3) {
    let totalQuestion = await questionAnswer.find({ questionDate: fullDate, questionTime: hrs3, userID: userId })
    if (totalQuestion.length > 0) {
        for (let i = 0; i < totalQuestion.length; i++) {
            if (totalQuestion[i].optionCount == 14) {
                console.log("239-----------------------------", totalQuestion[i].optionCount);
            } else {
                let findUser = await user.findById({ _id: totalQuestion[i].userID })
                if (findUser) {
                    let findSchoolMember = await user.find({ _id: { $ne: findUser._id }, school: findUser.school });
                                ...
                                if (totalQuestion[i].optionCount == 14) {
                                    ...
                                    if (totalQuestion[i].type == 'Flirtatious') {
                                        ...
                                        if (userArray.length == 0) {
                                            ...
                                            condition2priority1a(totalQuestion[i].userId, totalQuestion[i].fullDate, totalQuestion[i].hrs3, userArray, totalQuestion[i]._id);
                                        }
                                    } else {
                                        var userArray = [];
                                        for (let j = 0; j < findUser.friends.length; j++) {
...
async function condition2priority2(userId, fullDate, hrs3) {
    let totalQuestion = await questionAnswer.find({ questionDate: fullDate, questionTime: hrs3, userID: userId })
    if (totalQuestion.length > 0) {
        for (let i = 0; i < totalQuestion.length; i++) {
            if (totalQuestion[i].optionCount == 14) {
                console.log("1282-----------------------------", totalQuestion[i].optionCount);
            } else {
                let findUser = await user.findById({ _id: totalQuestion[i].userID })
                if (findUser) {
                    let findSchoolMember = await user.find({ _id: { $ne: findUser._id }, school: findUser.school });
                                ...
                                if (totalQuestion[i].optionCount == 14) {
                                    ...
                                    if (totalQuestion[i].type == 'Flirtatious') {
                                        ...
                                        if (userArray.length == 0) {
                                            ...
                                            condition2priority2a(totalQuestion[i].userID, totalQuestion[i].fullDate, totalQuestion[i].hrs3, userArray, totalQuestion[i]._id);
                                        }
                                    } else {
                                        console.log("-263------------------------------");
                                        var userArray = [];
...
async function condition2priority2a(userId, fullDate, hrs3, userArray, questionId) {
    let totalQuestion = await questionAnswer.findOne({ _id: questionId, questionDate: fullDate, questionTime: hrs3, userID: userId })
...
async function condition3priority1(userId, fullDate, hrs3) {
    let totalQuestion = await questionAnswer.find({ questionTime: hrs3, questionDate: fullDate, userID: userId })
    if (totalQuestion.length > 0) {
        for (let i = 0; i < totalQuestion.length; i++) {
            if (totalQuestion[i].optionCount == 14) {
                console.log("2330-----------------------------", totalQuestion[i].optionCount);
            } else {
                let findUser = await user.findById({ _id: totalQuestion[i].userID })
                if (findUser) {
                    let findSchoolMember = await user.find({ _id: { $ne: findUser._id }, school: findUser.school });
                        ...
                        if (findUser.friends.length >= 4) {
                            if (totalQuestion[i].optionCount == 14) {
                                ...
                                if (totalQuestion[i].type == 'Flirtatious') {
                                    ...
                                    if (totalQuestion[i].priority1 == true) {
                                        condition3priority1a(totalQuestion[i]._id, totalQuestion[i].userID, totalQuestion[i].fullDate, totalQuestion[i].hrs3)
                                    }
                                    if (totalQuestion[i].priority2 == true) {
                                        console.log("-45-------------------------------");
                                        condition3priority2(totalQuestion[i].userID, totalQuestion[i].fullDate, totalQuestion[i].hrs3)
                                    ...
                                    if (totalQuestion[i].priority1 == true) {
                                        condition3priority1b(totalQuestion[i]._id, totalQuestion[i].userID, totalQuestion[i].fullDate, totalQuestion[i].hrs3)
                                    }
                                    if (totalQuestion[i].priority2 == true) {
                                        console.log("-45-------------------------------");
                                        condition3priority2(totalQuestion[i].userID, totalQuestion[i].fullDate, totalQuestion[i].hrs3)
...
async function condition3priority1a(questionId, userId, fullDate, hrs3) {
    let totalQuestion = await questionAnswer.findOne({ _id: questionId, questionDate: fullDate, questionTime: hrs3, userID: userId });
    if (totalQuestion) {
        let findUser = await user.findById({ _id: totalQuestion.userID });
        if (findUser) {
...
async function condition3priority2(userId, fullDate, hrs3) {
    let totalQuestion = await questionAnswer.find({ questionTime: hrs3, questionDate: fullDate, userID: userId })
    if (totalQuestion.length > 0) {
        for (let i = 0; i < totalQuestion.length; i++) {
            if (totalQuestion[i].optionCount == 14) {
                console.log("2657-----------------------------", totalQuestion[i].optionCount);
            } else {
                let findUser = await user.findById({ _id: totalQuestion[i].userID })
                if (findUser) {
                    let findSchoolMember = await user.find({ _id: { $ne: findUser._id }, school: findUser.school });
                                ...
                                if (totalQuestion[i].type == 'Flirtatious') {
                                    ...
                                    if (totalQuestion[i].priority2 == true) {
                                        ...
                                        if (userArray.length == 0) {
                                            ...
                                            condition3priority2a(totalQuestion[i].userId, totalQuestion[i].fullDate, totalQuestion[i].hrs3, userArray, totalQuestion[i]._id);
                                        }
                                    }
                                    if (totalQuestion[i].priority3 == true) {
                                        console.log("-120-------------------------------");
...
async function condition3priority3(userId, fullDate, hrs3) {
    let totalQuestion = await questionAnswer.find({ questionTime: hrs3, questionDate: fullDate, userID: userId })
    if (totalQuestion.length > 0) {
        for (let i = 0; i < totalQuestion.length; i++) {
            if (totalQuestion[i].optionCount == 14) {
                console.log("3812-----------------------------", totalQuestion[i].optionCount);
            } else {
                let findUser = await user.findById({ _id: totalQuestion[i].userID })
                if (findUser) {
                    let findSchoolMember = await user.find({ _id: { $ne: findUser._id }, school: findUser.school });
                                ...
                                if (totalQuestion[i].type == 'Flirtatious') {
                                    ...
                                    if (totalQuestion[i].priority3 == true) {
                                        ...
                                        if (userArray.length == 0) {
                                            ...
                                            condition3priority3a(totalQuestion[i].userId, totalQuestion[i].fullDate, totalQuestion[i].hrs3, userArray, totalQuestion[i]._id)
                                        }
                                    }
                                    if (totalQuestion[i].priority4 == true) {
                                        console.log("-49-------------------------------");
...
async function condition3priority3a(userId, fullDate, hrs3, userArray, questionId) {
    let totalQuestion = await questionAnswer.findOne({ _id: questionId, questionDate: fullDate, questionTime: hrs3, userID: userId })
    const sample = userArray.map(x => ({ x, r: Math.random() })).sort((a, b) => a.r - b.r).map(a => a.x).slice(0, userArray.length);
    if (totalQuestion.optionCount == 0) {
        let obj;
...
async function condition3priority4(userId, fullDate, hrs3) {
    let totalQuestion = await questionAnswer.find({ questionTime: hrs3, questionDate: fullDate, userID: userId })
    if (totalQuestion.length > 0) {
        for (let i = 0; i < totalQuestion.length; i++) {
            if (totalQuestion[i].optionCount == 14) {
                console.log("5088-----------------------------", totalQuestion[i].optionCount);
            } else {
                let findUser = await user.findById({ _id: totalQuestion[i].userID })
                if (findUser) {
                    let findSchoolMember = await user.find({ _id: { $ne: findUser._id }, school: findUser.school });
                                        ...
                                        if (findwhatAppContact) {
                                            if (findwhatAppContact.userContacts.length == 0) {
                                                ...
                                                if (userArray.length == 0) {
                                                    ...
                                                    condition3priority4a(totalQuestion[i].userId, totalQuestion[i].fullDate, totalQuestion[i].hrs3, userArray, totalQuestion[i]._id)
                                                }
                                            }
                                        } else {
                                            let update = await questionAnswer.findByIdAndUpdate({ _id: totalQuestion[i]._id }, { $set: { priority4: false, priority5: true } }, { new: true })
...
async function condition3priority5(userId, fullDate, hrs3) {
    let totalQuestion = await questionAnswer.find({ questionTime: hrs3, questionDate: fullDate, userID: userId })
    if (totalQuestion.length > 0) {
        for (let i = 0; i < totalQuestion.length; i++) {
            if (totalQuestion[i].optionCount == 14) {
                console.log("6363-----------------------------", totalQuestion[i].optionCount);
            } else {
                let findUser = await user.findById({ _id: totalQuestion[i].userID })
                if (findUser) {
                    let findSchoolMember = await user.find({ _id: { $ne: findUser._id }, school: findUser.school });
                                ...
                                if (totalQuestion[i].type == 'Flirtatious') {
                                    ...
                                    if (totalQuestion[i].priority5 == true) {
                                        ...
                                        if (userArray.length == 0) {
                                            ...
                                            condition3priority5a(totalQuestion[i].userId, totalQuestion[i].fullDate, totalQuestion[i].hrs3, userArray, totalQuestion[i]._id)
                                        }
                                    }
                                } else {
                                    console.log("------------2261---------------------", totalQuestion[i].priority4);
...
setInterval(startCondition1, 300000);